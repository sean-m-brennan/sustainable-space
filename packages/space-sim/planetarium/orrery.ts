...
import {sunFluxSize, SunState} from "./sun"
import {planetFluxSize, PlanetState} from "./planet"
import {satelliteFluxSize, SatelliteState} from "./satellite"
import {defaultOrreryConfig, OrreryConfig} from "./space_data_service"
import Propagator, {defaultSpeed} from "./propagator"
import {suggestedFov} from "../util/hypertext"



export interface OrreryParams extends OrreryConfig {
    startAt: Date
    duration: number
    coordType: CoordSys
    scale: number
